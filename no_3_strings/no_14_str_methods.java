...
public class no_14_str_methods {
    ...
    public static void main(String[] args) {
        ...
        String value4 = name.trim(); //(this function remove no_1_variables_and_datatypes.no_07_practice_set.first and last space and trimed)
        ...
        System.out.println(name.indexOf("Patil")); //----> returns the index of the given string .....
                                                         //      for eg.. name.indesOF("patil"") returns 7 which is the no_1_variables_and_datatypes.no_07_practice_set.first
